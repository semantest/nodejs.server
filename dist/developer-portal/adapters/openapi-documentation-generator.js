...
exports.OpenApiDocumentationGenerator = void 0;
const typescript_eda_stubs_1 = require("../../stubs/typescript-eda-stubs");
/**
 * OpenAPI documentation generator for API documentation
 */
class OpenApiDocumentationGenerator extends typescript_eda_stubs_1.Adapter {
    constructor() {
        super();
     ...
     */
    async generateOpenApiSpec(endpoints, options) {
     ...
     */
    async generatePostmanCollection(endpoints, options) {
        const apiEndpoints = await this.getEndpointDefinitions(endpoints);
     ...
     */
    async generateInsomniaCollection(endpoints, options) {
        const apiEndpoints = await this.getEndpointDefinitions(endpoints);
     ...
     */
    async generateCurlExamples(endpoints, options) {
        const apiEndpoints = await this.getEndpointDefinitions(endpoints);
     ...
     * Helper methods
     */
    async getEndpointDefinitions(endpoints) {
    ...
    extractSchemaReferences(schema, schemas) {
    ...
    generatePostmanItems(endpoints) {
        return endpoints.map(endpoint => ({
            name: `${endpoint.method} ${endpoint.path}`,
            request: {
                method: endpoint.method,
    ...
    generateInsomniaResources(endpoints) {
        const resources = [];
        // Add workspace
        resources.push({
            _id: 'wrk_1',
...
//# sourceMappingURL=openapi-documentation-generator.js.map