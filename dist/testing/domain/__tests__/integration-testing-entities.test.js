...
const integration_testing_entities_1 = require("../integration-testing-entities");
describe('Integration Testing Entities', () => {
    ...
    describe('Constants', () => {
        describe('TEST_TYPES', () => {
            it('should have all test types', () => {
                expect(integration_testing_entities_1.TEST_TYPES.UNIT).toBe('unit');
                expect(integration_testing_entities_1.TEST_TYPES.INTEGRATION).toBe('integration');
                expect(integration_testing_entities_1.TEST_TYPES.E2E).toBe('e2e');
                expect(integration_testing_entities_1.TEST_TYPES.LOAD).toBe('load');
                expect(integration_testing_entities_1.TEST_TYPES.SECURITY).toBe('security');
            });
            it('should match TestSuite type values', () => {
                const suite = {
                    ...
                    description: 'Test',
                    version: '1.0.0',
                    type: integration_testing_entities_1.TEST_TYPES.INTEGRATION,
                    environment: 'test',
                    tests: [],
                    hooks: [],
                    configuration: {
                ...
                expect([
                    integration_testing_entities_1.TEST_TYPES.UNIT,
                    integration_testing_entities_1.TEST_TYPES.INTEGRATION,
                    integration_testing_entities_1.TEST_TYPES.E2E,
                    integration_testing_entities_1.TEST_TYPES.LOAD,
                    integration_testing_entities_1.TEST_TYPES.SECURITY
                ]).toContain(suite.type);
            });
        });
        describe('TEST_STATUS', () => {
            it('should have all test statuses', () => {
                expect(integration_testing_entities_1.TEST_STATUS.PASSED).toBe('passed');
                expect(integration_testing_entities_1.TEST_STATUS.FAILED).toBe('failed');
                expect(integration_testing_entities_1.TEST_STATUS.SKIPPED).toBe('skipped');
                expect(integration_testing_entities_1.TEST_STATUS.TIMEOUT).toBe('timeout');
                expect(integration_testing_entities_1.TEST_STATUS.ERROR).toBe('error');
            });
            it('should match TestCaseResult status values', () => {
                const result = {
                    id: 'test',
                    name: 'Test',
                    status: integration_testing_entities_1.TEST_STATUS.PASSED,
                    duration: 100,
                    startTime: new Date(),
                    endTime: new Date(),
                    steps: []
                ...
                expect([
                    integration_testing_entities_1.TEST_STATUS.PASSED,
                    integration_testing_entities_1.TEST_STATUS.FAILED,
                    integration_testing_entities_1.TEST_STATUS.SKIPPED,
                    integration_testing_entities_1.TEST_STATUS.TIMEOUT,
                    integration_testing_entities_1.TEST_STATUS.ERROR
                ]).toContain(result.status);
            });
        });
        describe('SECURITY_SEVERITY', () => {
            it('should have all severity levels', () => {
                expect(integration_testing_entities_1.SECURITY_SEVERITY.LOW).toBe('low');
                expect(integration_testing_entities_1.SECURITY_SEVERITY.MEDIUM).toBe('medium');
                expect(integration_testing_entities_1.SECURITY_SEVERITY.HIGH).toBe('high');
                expect(integration_testing_entities_1.SECURITY_SEVERITY.CRITICAL).toBe('critical');
            });
            it('should match SecurityVulnerability severity values', () => {
                const vuln = {
                    ...
                    name: 'Test',
                    description: 'Test',
                    severity: integration_testing_entities_1.SECURITY_SEVERITY.HIGH,
                    category: 'test',
                    endpoint: '/test',
                    method: 'GET',
                    impact: 'test',
                ...
                expect([
                    integration_testing_entities_1.SECURITY_SEVERITY.LOW,
                    integration_testing_entities_1.SECURITY_SEVERITY.MEDIUM,
                    integration_testing_entities_1.SECURITY_SEVERITY.HIGH,
                    integration_testing_entities_1.SECURITY_SEVERITY.CRITICAL
                ]).toContain(vuln.severity);
            });
        });
        describe('COMPLIANCE_FRAMEWORKS', () => {
            it('should have all compliance frameworks', () => {
                expect(integration_testing_entities_1.COMPLIANCE_FRAMEWORKS.OWASP).toBe('owasp');
                expect(integration_testing_entities_1.COMPLIANCE_FRAMEWORKS.NIST).toBe('nist');
                expect(integration_testing_entities_1.COMPLIANCE_FRAMEWORKS.ISO27001).toBe('iso27001');
                expect(integration_testing_entities_1.COMPLIANCE_FRAMEWORKS.SOC2).toBe('soc2');
                expect(integration_testing_entities_1.COMPLIANCE_FRAMEWORKS.GDPR).toBe('gdpr');
            });
            it('should have unique framework values', () => {
                const frameworks = Object.values(integration_testing_entities_1.COMPLIANCE_FRAMEWORKS);
    ...
    describe('Type Safety and Const Assertions', () => {
        it('should have readonly TEST_TYPES', () => {
            const types = integration_testing_entities_1.TEST_TYPES;
        ...
        it('should have readonly TEST_STATUS', () => {
            const status = integration_testing_entities_1.TEST_STATUS;
        ...
        it('should have readonly SECURITY_SEVERITY', () => {
            const severity = integration_testing_entities_1.SECURITY_SEVERITY;
        ...
        it('should have readonly COMPLIANCE_FRAMEWORKS', () => {
            const frameworks = integration_testing_entities_1.COMPLIANCE_FRAMEWORKS;
    ...
    describe('Business Logic Validation', () => {
        ...
        it('should have valid compliance scoring', () => {
            ...
            expect(compliance.totalRequirements).toBe(compliance.passedRequirements + compliance.failedRequirements);
...
//# sourceMappingURL=integration-testing-entities.test.js.map