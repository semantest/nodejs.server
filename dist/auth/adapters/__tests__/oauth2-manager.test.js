...
const oauth2_manager_1 = require("../oauth2-manager");
describe('OAuth2Manager', () => {
    ...
    beforeEach(() => {
        ...
        oauth2Manager = new oauth2_manager_1.OAuth2Manager();
    });
    afterEach(() => {
    ...
    describe('constructor', () => {
        ...
        it('should initialize without providers when environment variables are not set', () => {
            process.env = {};
            const emptyOAuth2Manager = new oauth2_manager_1.OAuth2Manager();
        ...
        it('should initialize only configured providers', () => {
            ...
            const partialOAuth2Manager = new oauth2_manager_1.OAuth2Manager();
    ...
    describe('exchangeCodeForToken', () => {
        ...
        it('should handle token exchange errors', async () => {
            ...
            oauth2Manager.makeTokenRequest = jest.fn().mockRejectedValue(new Error('Token exchange failed'));
    ...
    describe('refreshToken', () => {
        ...
        it('should handle token refresh errors', async () => {
            const refreshToken = 'refresh-token-123';
            // Mock the makeTokenRequest to throw an error
            oauth2Manager.makeTokenRequest = jest.fn().mockRejectedValue(new Error('Token refresh failed'));
    ...
    describe('getUserInfo', () => {
        ...
        it('should normalize GitHub user info', async () => {
            ...
            oauth2Manager.makeUserInfoRequest = jest.fn().mockResolvedValue({
                id: 12345,
        ...
        it('should handle user info errors', async () => {
            ...
            oauth2Manager.makeUserInfoRequest = jest.fn().mockRejectedValue(new Error('User info failed'));
    ...
    describe('revokeToken', () => {
        ...
        it('should handle revocation errors', async () => {
            ...
            oauth2Manager.makeRevokeRequest = jest.fn().mockRejectedValue(new Error('Revocation failed'));
    ...
    describe('getAvailableProviders', () => {
        ...
        it('should filter out inactive providers', () => {
            ...
            const providersMap = oauth2Manager.providers;
...
//# sourceMappingURL=oauth2-manager.test.js.map