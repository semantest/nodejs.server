...
const auth_entities_1 = require("../auth-entities");
    ...
    describe('Constants', () => {
        describe('RATE_LIMIT_TIERS', () => {
            it('should have correct values for free tier', () => {
                const freeTier = auth_entities_1.RATE_LIMIT_TIERS.free;
            ...
            it('should have correct values for premium tier', () => {
                const premiumTier = auth_entities_1.RATE_LIMIT_TIERS.premium;
            ...
            it('should have correct values for enterprise tier', () => {
                const enterpriseTier = auth_entities_1.RATE_LIMIT_TIERS.enterprise;
            ...
            it('should have progressively higher limits', () => {
                expect(auth_entities_1.RATE_LIMIT_TIERS.premium.requestsPerMinute).toBeGreaterThan(auth_entities_1.RATE_LIMIT_TIERS.free.requestsPerMinute);
                expect(auth_entities_1.RATE_LIMIT_TIERS.enterprise.requestsPerMinute).toBeGreaterThan(auth_entities_1.RATE_LIMIT_TIERS.premium.requestsPerMinute);
            });
        });
        describe('DEFAULT_PERMISSIONS', () => {
            it('should have correct user permissions', () => {
                const userPerms = auth_entities_1.DEFAULT_PERMISSIONS.user;
            ...
            it('should have correct admin permissions', () => {
                const adminPerms = auth_entities_1.DEFAULT_PERMISSIONS.admin;
                ...
                expect(adminPerms.length).toBeGreaterThan(auth_entities_1.DEFAULT_PERMISSIONS.user.length);
            });
            it('should have wildcard for super admin', () => {
                const superAdminPerms = auth_entities_1.DEFAULT_PERMISSIONS.super_admin;
...
//# sourceMappingURL=auth-entities.test.js.map