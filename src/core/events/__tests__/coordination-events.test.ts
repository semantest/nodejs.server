...
describe('Coordination Events with Chrome API Mocking', () => {
  // Test data factories
  const createExtensionMetadata = (): ExtensionMetadata => ({
    version: '1.0.0',
    name: 'Test Extension',
  ...
  const createConnectionInfo = (): ConnectionInfo => ({
    ipAddress: '127.0.0.1',
    userAgent: 'Mozilla/5.0 Chrome/120.0.0',
    timestamp: new Date(),
    protocol: 'websocket',
  ...
  const createAutomationPayload = (): AutomationPayload => ({
    action: 'click',
    target: {
  ...
  describe('ExtensionConnectedEvent', () => {
    it('should create event with Chrome runtime data', () => {
      ...
      const event = new ExtensionConnectedEvent(extensionId, metadata, connectionInfo);
    ...
    it('should handle Chrome manifest data', () => {
      ...
      const event = new ExtensionConnectedEvent('ext-123', metadata, createConnectionInfo());
  ...
  describe('ExtensionDisconnectedEvent', () => {
    it('should create disconnection event with proper reason', () => {
      const event = new ExtensionDisconnectedEvent(
        'ext-123',
        'connection_timeout',
        3600000 // 1 hour
      );
    ...
    it('should support all disconnection reasons', () => {
      ...
      reasons.forEach(reason => {
        const event = new ExtensionDisconnectedEvent('ext-123', reason, 1000);
  ...
  describe('AutomationRequestReceivedEvent', () => {
    it('should create automation request with Chrome tab info', async () => {
      ...
      const event = new AutomationRequestReceivedEvent(
        'req-123',
        'client-456',
        'ext-789',
        tabId,
  ...
  describe('AutomationRequestRoutedEvent', () => {
    it('should create routing event with decision data', () => {
      ...
      const event = new AutomationRequestRoutedEvent(
        'req-123',
        'ext-primary',
        routingDecision
      );
    ...
    it('should support all routing reasons', () => {
      ...
      reasons.forEach(reason => {
        ...
        const event = new AutomationRequestRoutedEvent('req-123', 'ext-123', decision);
  ...
  describe('AutomationResponseReceivedEvent', () => {
    it('should create response event with Chrome tab metadata', () => {
      ...
      const event = new AutomationResponseReceivedEvent(
        'req-123',
        'ext-456',
        response,
        1300
    ...
    it('should handle error responses', () => {
      ...
      const event = new AutomationResponseReceivedEvent('req-456', 'ext-789', response, 5100);
  ...
  describe('AutomationRequestFailedEvent', () => {
    it('should create failure event with error details', () => {
      ...
      const event = new AutomationRequestFailedEvent(
        'req-123',
        'ext-456',
        error,
        2
  ...
  describe('CoordinationSessionStartedEvent', () => {
    it('should create session start event with configuration', () => {
      ...
      const event = new CoordinationSessionStartedEvent(
        'session-123',
        'client-456',
        'automation',
        config
  ...
  describe('CoordinationSessionEndedEvent', () => {
    it('should create session end event with statistics', () => {
      ...
      const event = new CoordinationSessionEndedEvent(
        'session-123',
        3600000, // 1 hour
        stats,
        'completed'
  ...
  describe('ExtensionHeartbeatReceivedEvent', () => {
    it('should create heartbeat event with extension status', () => {
      ...
      const event = new ExtensionHeartbeatReceivedEvent('ext-123', status, metrics);
  ...
  describe('ExtensionHeartbeatMissedEvent', () => {
    it('should create missed heartbeat event', () => {
      ...
      const event = new ExtensionHeartbeatMissedEvent('ext-123', 3, lastSeen);
  ...
  describe('CoordinationErrorEvent', () => {
    it('should create error event with recovery action', () => {
      ...
      const event = new CoordinationErrorEvent(error, context, recovery);
    ...
    it('should support all recovery types', () => {
      ...
      recoveryTypes.forEach(type => {
        ...
        const event = new CoordinationErrorEvent(
          new Error('Test'),
          {
            operation: 'test',
            timestamp: new Date()
  ...
  describe('CoordinationMetricsUpdatedEvent', () => {
    it('should create metrics update event', () => {
      ...
      const event = new CoordinationMetricsUpdatedEvent(metrics, 'periodic');
    ...
    it('should support all update types', () => {
      ...
      updateTypes.forEach(updateType => {
        const event = new CoordinationMetricsUpdatedEvent(
          {
            activeExtensions: 1,
            activeSessions: 1,
            requestsPerSecond: 1,
  ...
  describe('Chrome API Integration Tests', () => {
    ...
    it('should use Chrome runtime API for extension connection', async () => {
      ...
      const event = new ExtensionConnectedEvent(
        mockChromeAPI.runtime.id,
        metadata,
        connectionInfo
      );
    ...
    it('should handle Chrome runtime errors', () => {
      ...
      const event = new CoordinationErrorEvent(
        new Error(mockChromeAPI.runtime.lastError.message),
        context
      );
