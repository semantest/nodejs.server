...
import { ItemEntity, Item, ItemHistoryEntry } from '../item.entity';
...
describe('ItemEntity', () => {
  ...
  describe('Constructor', () => {
    it('should create item with provided data', () => {
      ...
      const item = new ItemEntity(data);
    ...
    it('should generate id if not provided', () => {
      const item = new ItemEntity({ name: 'Test Item' });
  ...
  describe('changeStatus', () => {
    ...
    beforeEach(() => {
      item = new ItemEntity({ name: 'Test Item', status: 'active' });
      uuidCounter = 2;
    });
    ...
    it('should handle all status transitions', () => {
      ...
      const item2 = new ItemEntity({ name: 'Test Item 2', status: 'inactive' });
  ...
  describe('toJSON', () => {
    it('should return plain object representation', () => {
      ...
      expect(json).not.toBeInstanceOf(ItemEntity);
    });
  ...
  describe('fromJSON', () => {
    it('should create entity from plain object', () => {
      ...
      const item = ItemEntity.fromJSON(data);
    ...
    it('should restore history if provided', () => {
      ...
      const item = ItemEntity.fromJSON(data, history);
  ...
  describe('Edge Cases', () => {
    it('should handle empty string name', () => {
      const item = new ItemEntity({ name: '' });
      expect(item.name).toBe('');
    });

    it('should handle very long names', () => {
      const longName = 'a'.repeat(1000);
      const item = new ItemEntity({ name: longName });
    ...
    it('should handle rapid successive updates', () => {
      const item = new ItemEntity({ name: 'Test' });
