...
import { OpenApiDocumentationGenerator } from '../openapi-documentation-generator';
import { ApiDocumentation, ApiEndpoint } from '../../domain/developer-portal-entities';

describe('OpenApiDocumentationGenerator', () => {
  let generator: OpenApiDocumentationGenerator;
  ...
  beforeEach(() => {
    ...
    generator = new OpenApiDocumentationGenerator();
  });
  ...
  describe('constructor', () => {
    ...
    it('should use default values when environment variables are not set', () => {
      process.env = {};
      const defaultGenerator = new OpenApiDocumentationGenerator();
  ...
  describe('generatePostmanCollection', () => {
    ...
    it('should include variables', async () => {
      ...
      expect(content.variable).toEqual(
        expect.arrayContaining([
          expect.objectContaining({
            key: 'base_url',
  ...
  describe('generateInsomniaCollection', () => {
    ...
    it('should include workspace and environment', async () => {
      ...
      const environment = resources.find((r: any) => r._type === 'environment');
